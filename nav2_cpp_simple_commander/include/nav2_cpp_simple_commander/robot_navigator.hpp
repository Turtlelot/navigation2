...
public:
  ...
  {
    nav_to_pose_client_ = rclcpp_action::create_client<NavToPoseT>(this, "navigate_to_pose");
    follow_gps_waypoints_client_ =
      rclcpp_action::create_client<FollowGPSWaypointsT>(this, "follow_gps_waypoints");
    follow_path_client_ = rclcpp_action::create_client<FollowPathT>(this, "follow_path");
    navigation_through_poses_client_ =
      rclcpp_action::create_client<NavigateThroughPosesT>(this, "navigation_through_poses");
    smooth_path_client_ = rclcpp_action::create_client<SmoothPathT>(this, "smooth_path");
...
private:
  ...
  using FollowGPSWaypointsHandle = rclcpp_action::ClientGoalHandle<FollowGPSWaypointsT>;
  using FollowPathHandle = rclcpp_action::ClientGoalHandle<FollowPathT>;
  using NavigateThroughPosesHandle = rclcpp_action::ClientGoalHandle<NavigateThroughPosesT>;
  ...
  rclcpp_action::Client<FollowGPSWaypointsT>::SharedPtr follow_gps_waypoints_client_;
  rclcpp_action::Client<FollowPathT>::SharedPtr follow_path_client_;
  rclcpp_action::Client<NavigateThroughPosesT>::SharedPtr navigation_through_poses_client_;
  ...
  std::shared_future<FollowGPSWaypointsHandle::SharedPtr> future_follow_gps_waypoints_;
  std::shared_future<FollowPathHandle::SharedPtr> future_follow_path_;
  std::shared_future<NavigateThroughPosesHandle::SharedPtr> future_navigation_through_poses_;
